...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/hardphp.js"></script>
</head>
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="hard-navbar">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#" class="atip" target="appiframe" data-toggle="tooltip" data-placement="bottom" data-title="首页"
    ...
    <div class="container-fluid mybody">
        <div class="main-wapper">
            ...
            <div id="content" class="main-content">
                ...
                <iframe src="welcome.html?name=${activeUser.username}" style="width:100%;height: 100%;" id="appiframe" name="appiframe" frameborder="0"></iframe>
