...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/deployProcess" enctype="multipart/form-data" method="post" id="form">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <button type="submit" class="btn btn-primary" onclick="submitProcess()">部署流程</button>
                        </div>
                </div>
            </form>
        </div>
